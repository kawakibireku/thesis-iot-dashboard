    ...
    <div class="card col-span-3">
      ...
      <div class="flex justify-between mb-10">
        ...
        <div class="flex gap-1.5">
          <button v-on:click="changeDevice(1)" :class="{active: idActive == 1}" class="primary-button py-1.5 text-sm rounded-lg">CO<sup>2</sup></button>
          <button v-on:click="changeDevice(1)" :class="{active: idActive == 1}" class="primary-button py-1.5 text-sm rounded-lg">CO</button>
          <button v-on:click="changeDevice(1)" :class="{active: idActive == 1}" class="primary-button py-1.5 text-sm rounded-lg">NO</button>
        </div>
