...
<template>
    ...
    <VueDatePicker class="mb-5 !w-[350px] float-right" :enable-time-picker="false" range="true" v-model="date"></VueDatePicker>
    <!-- device information -->
    ...
    <div class="card col-span-3">
      ...
      <div class="flex justify-between mb-10">
        ...
        <div class="flex gap-1.5">
          <button v-on:click="changeDevice(1)" :class="{active: typeSelected == 1}" class="primary-button py-1.5 text-sm rounded-lg">CO<sup>2</sup></button>
          <button v-on:click="changeDevice(1)" :class="{active: typeSelected == 1}" class="primary-button py-1.5 text-sm rounded-lg">CO</button>
          <button v-on:click="changeDevice(1)" :class="{active: typeSelected == 1}" class="primary-button py-1.5 text-sm rounded-lg">NO</button>
        </div>
