...
<template>
    ...
    <VueDatePicker class="mb-5 !w-[350px] float-right !z-0" :enable-time-picker="false" range="true" v-model="date"></VueDatePicker>
    <!-- device information -->
    ...
    <!-- body charts -->
    <client-only>
           <ApexChart width="100%" height="500" type="line" :options="options" :series="series" />
        </div>
    </div>
</client-only>
</template>
